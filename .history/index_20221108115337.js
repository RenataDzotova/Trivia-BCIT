...
const allQuestions = {
  ...
  4:{
    ...
    ans:"opt1",
    happy: "public/ok.jpeg",
    sad: "public/classroom.png"
  },
  5:{
    num: "5",
...
app.get('/checkAnswer', (req, res)=>{
  ...
  console.log(allQuestions[req.query.answer].sad)
   if((req.query.question) === allQuestions[req.query.answer].ans){
    res.json({fact:true, score:score, image:allQuestions[req.query.answer].happy});
    score ++

  } else {
    res.json({fact:false, score:score, image:allQuestions[req.query.answer].sad});
    if(score >= 1){
        score--;
    } else {
        score
