...
const allQuestions = {
  ...
  4:{
    ...
    ans:"opt1",
    happy: "https://www.verywellmind.com/thmb/_pXWd7IDH4N7B-nU_dttDb71l50=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Stocksy_happy-woman_561241-5797837a5f9b58461f05b4cd.jpg",
    sad: "http://placekitten.com/100/100"
  },
  5:{
    num: "5",
...
app.get('/checkAnswer', (req, res)=>{
  ...
  console.log(allQuestions[4].sad)
   if((req.query.question) === allQuestions[req.query.answer].ans){
    res.json({fact:true, score:score, image:allQuestions[4].happy});
    score ++

  } else {
    res.json({fact:false, score:score, image:allQuestions[4].sad});
    if(score >= 1){
        score--;
    } else {
        score
