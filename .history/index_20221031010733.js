...
app.get('/bow', (req, res)=>{
    ...
    // res.render("/questionOne.html")
})

app.get('/q1', (req, res)=>{ //? This will now make an object out of whatever query is inserted in the searchbar, for example, "localhost:3000/?name=cocoa" will console.log { name: 'cocoa' }
  res.sendFile(q1)
})

app.get('/true', (req, res)=>{
  res.json("Unfortunately, that fact is true")
})

app.get('/false', (req, res)=>{
  res.json("Correct, that fact wasn't true!")
})
