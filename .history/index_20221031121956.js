...
const trueFile =  path.join(__dirname,'views/true.html')
const falseFile =  path.join(__dirname,'views/false.html')
...
app.get('/checkanswer', (req, res)=>{
  const answer = 3
  if(trueButton == answer){
    res.json("Correct, that fact wasn't true!")
  }
//   const answer = 3
//   document.addEventListener('click',(event)=>{
//     if(event.target.id == answer) return giveUserPlusOne()
//     resultView.innerText = "bad"
// })
